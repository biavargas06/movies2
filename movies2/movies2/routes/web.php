...
Route::match(['get', 'post'], '/', function (Request $request) {
    ...
    $movies = Filme::select('movie.idmovie', 'movie.nome', \DB::raw('GROUP_CONCAT(genero.nome SEPARATOR ", ") AS generos'))
        ->join('genero', 'movie.idmovie', '=', 'genero.movie_idmovie')
        ->join('genero as genero2', 'genero.idgenero', '=', 'genero2.idgenero')
        ->groupBy('movie.idmovie', 'movie.nome')
        ->get();
